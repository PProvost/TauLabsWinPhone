...
namespace UavTalk
{
	...
	{
		public const long OBJID = 2270220056;
		...
		public UAVObjectField<float> VbarRollPID;
		public UAVObjectField<float> VbarPitchPID;
		public UAVObjectField<float> VbarYawPID;
		...
		public StabilizationSettings() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
			...
			List<String> VbarRollPIDElemNames = new List<String>();
			VbarRollPIDElemNames.Add("Kp");
			VbarRollPIDElemNames.Add("Ki");
			VbarRollPIDElemNames.Add("Kd");
			VbarRollPID=new UAVObjectField<float>("VbarRollPID", "1/(deg/s)", VbarRollPIDElemNames, null, this);
			fields.Add(VbarRollPID);

			List<String> VbarPitchPIDElemNames = new List<String>();
			VbarPitchPIDElemNames.Add("Kp");
			VbarPitchPIDElemNames.Add("Ki");
			VbarPitchPIDElemNames.Add("Kd");
			VbarPitchPID=new UAVObjectField<float>("VbarPitchPID", "1/(deg/s)", VbarPitchPIDElemNames, null, this);
			fields.Add(VbarPitchPID);

			List<String> VbarYawPIDElemNames = new List<String>();
			VbarYawPIDElemNames.Add("Kp");
			VbarYawPIDElemNames.Add("Ki");
			VbarYawPIDElemNames.Add("Kd");
			VbarYawPID=new UAVObjectField<float>("VbarYawPID", "1/(deg/s)", VbarYawPIDElemNames, null, this);
			fields.Add(VbarYawPID);
			...
			List<String> CoordinatedFlightYawPIElemNames = new List<String>();
			CoordinatedFlightYawPIElemNames.Add("Kp");
			CoordinatedFlightYawPIElemNames.Add("Ki");
			CoordinatedFlightYawPIElemNames.Add("ILimit");
			CoordinatedFlightYawPI=new UAVObjectField<float>("CoordinatedFlightYawPI", "", CoordinatedFlightYawPIElemNames, null, this);
			fields.Add(CoordinatedFlightYawPI);
			...
			List<String> RateExpoElemNames = new List<String>();
			RateExpoElemNames.Add("Roll");
			RateExpoElemNames.Add("Pitch");
			RateExpoElemNames.Add("Yaw");
			RateExpo=new UAVObjectField<byte>("RateExpo", "%", RateExpoElemNames, null, this);
			fields.Add(RateExpo);
		...
		public void setDefaultFieldValues()
		{
			...
			VbarRollPID.setValue((float)0.005,0);
			VbarRollPID.setValue((float)0.002,1);
			VbarRollPID.setValue((float)0,2);
			VbarPitchPID.setValue((float)0.005,0);
			VbarPitchPID.setValue((float)0.002,1);
			VbarPitchPID.setValue((float)0,2);
			VbarYawPID.setValue((float)0.005,0);
			VbarYawPID.setValue((float)0.002,1);
			VbarYawPID.setValue((float)0,2);
			VbarTau.setValue((float)0.5);
			GyroTau.setValue((float)0.005);
			DerivativeGamma.setValue((float)1);
			WeakLevelingKp.setValue((float)0.1);
			CoordinatedFlightYawPI.setValue((float)0,0);
			CoordinatedFlightYawPI.setValue((float)0.1,1);
			CoordinatedFlightYawPI.setValue((float)0.5,2);
			RollMax.setValue((byte)55);
			PitchMax.setValue((byte)55);
			YawMax.setValue((byte)35);
			RateExpo.setValue((byte)0,0);
			RateExpo.setValue((byte)0,1);
			RateExpo.setValue((byte)0,2);
