...
namespace UavTalk
{
	...
	{
		public const long OBJID = 2914234630;
		...
		public UAVObjectField<float> ZAccelOffset;
		...
		public SensorSettings() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
			...
			List<String> ZAccelOffsetElemNames = new List<String>();
			ZAccelOffsetElemNames.Add("0");
			ZAccelOffset=new UAVObjectField<float>("ZAccelOffset", "m/s^2", ZAccelOffsetElemNames, null, this);
			fields.Add(ZAccelOffset);
