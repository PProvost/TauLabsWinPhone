...
namespace UavTalk
{
	...
	{
		public const long OBJID = 1546606764;
		public int NUMBYTES { get; set; }
		protected const String NAME = "ManualControlCommand";
	    protected static String DESCRIPTION = @"The output from the @ref ManualControlModule which decodes the receiver inputs.";
		...
		public UAVObjectField<UInt32> RawRssi;
		public UAVObjectField<float> Collective;
		public UAVObjectField<Int16> Rssi;
		...
		public ManualControlCommand() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
			...
			List<String> RawRssiElemNames = new List<String>();
			RawRssiElemNames.Add("0");
			RawRssi=new UAVObjectField<UInt32>("RawRssi", "", RawRssiElemNames, null, this);
			fields.Add(RawRssi);
			...
			RssiElemNames.Add("0");
			Rssi=new UAVObjectField<Int16>("Rssi", "%", RssiElemNames, null, this);
			fields.Add(Rssi);

			List<String> ChannelElemNames = new List<String>();
			ChannelElemNames.Add("Throttle");
			ChannelElemNames.Add("Roll");
			ChannelElemNames.Add("Pitch");
			ChannelElemNames.Add("Yaw");
			ChannelElemNames.Add("FlightMode");
			ChannelElemNames.Add("Collective");
			ChannelElemNames.Add("Accessory0");
			ChannelElemNames.Add("Accessory1");
			ChannelElemNames.Add("Accessory2");
			ChannelElemNames.Add("Arming");
