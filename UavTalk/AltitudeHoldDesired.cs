...
namespace UavTalk
{
	...
	{
		public const long OBJID = 2238722390;
		...
		public UAVObjectField<float> ClimbRate;
		...
		public AltitudeHoldDesired() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
			...
			List<String> ClimbRateElemNames = new List<String>();
			ClimbRateElemNames.Add("0");
			ClimbRate=new UAVObjectField<float>("ClimbRate", "m/s", ClimbRateElemNames, null, this);
			fields.Add(ClimbRate);
