...
namespace UavTalk
{
	...
	{
		public const long OBJID = 4065687500;
		...
		public enum PIDsUavEnum
		{
			...
			[Description("GyroTau")]
			GyroTau = 29, 
			[Description("Roll VbarSensitivity")]
			RollVbarSensitivity = 30, 
			[Description("Pitch VbarSensitivity")]
			PitchVbarSensitivity = 31, 
			[Description("Roll+Pitch VbarSensitivity")]
			RollPitchVbarSensitivity = 32, 
			[Description("Yaw VbarSensitivity")]
			YawVbarSensitivity = 33, 
			[Description("Roll Vbar.Kp")]
			RollVbarKp = 34, 
			[Description("Pitch Vbar.Kp")]
			PitchVbarKp = 35, 
			[Description("Roll+Pitch Vbar.Kp")]
			RollPitchVbarKp = 36, 
			[Description("Yaw Vbar.Kp")]
			YawVbarKp = 37, 
			[Description("Roll Vbar.Ki")]
			RollVbarKi = 38, 
			[Description("Pitch Vbar.Ki")]
			PitchVbarKi = 39, 
			[Description("Roll+Pitch Vbar.Ki")]
			RollPitchVbarKi = 40, 
			[Description("Yaw Vbar.Ki")]
			YawVbarKi = 41, 
			[Description("Roll Vbar.Kd")]
			RollVbarKd = 42, 
			[Description("Pitch Vbar.Kd")]
			PitchVbarKd = 43, 
			[Description("Roll+Pitch Vbar.Kd")]
			RollPitchVbarKd = 44, 
			[Description("Yaw Vbar.Kd")]
			YawVbarKd = 45, 
		}
		...
		public TxPIDSettings() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
			...
			PIDsEnumOptions.Add("Roll VbarSensitivity");
			PIDsEnumOptions.Add("Pitch VbarSensitivity");
			PIDsEnumOptions.Add("Roll+Pitch VbarSensitivity");
			PIDsEnumOptions.Add("Yaw VbarSensitivity");
			PIDsEnumOptions.Add("Roll Vbar.Kp");
			PIDsEnumOptions.Add("Pitch Vbar.Kp");
			PIDsEnumOptions.Add("Roll+Pitch Vbar.Kp");
			PIDsEnumOptions.Add("Yaw Vbar.Kp");
			PIDsEnumOptions.Add("Roll Vbar.Ki");
			PIDsEnumOptions.Add("Pitch Vbar.Ki");
			PIDsEnumOptions.Add("Roll+Pitch Vbar.Ki");
			PIDsEnumOptions.Add("Yaw Vbar.Ki");
			PIDsEnumOptions.Add("Roll Vbar.Kd");
			PIDsEnumOptions.Add("Pitch Vbar.Kd");
			PIDsEnumOptions.Add("Roll+Pitch Vbar.Kd");
			PIDsEnumOptions.Add("Yaw Vbar.Kd");
