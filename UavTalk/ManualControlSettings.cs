...
namespace UavTalk
{
	...
	{
		public const long OBJID = 1227616032;
		...
		public UAVObjectField<Int16> RssiMax;
		public UAVObjectField<Int16> RssiMin;
		public UAVObjectField<Int16> RssiPwmPeriod;
		...
		public UAVObjectField<RssiTypeUavEnum> RssiType;
		public UAVObjectField<byte> RssiChannelNumber;
		...
		public ManualControlSettings() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
			...
			List<String> RssiMaxElemNames = new List<String>();
			RssiMaxElemNames.Add("0");
			RssiMax=new UAVObjectField<Int16>("RssiMax", "", RssiMaxElemNames, null, this);
			fields.Add(RssiMax);

			List<String> RssiMinElemNames = new List<String>();
			RssiMinElemNames.Add("0");
			RssiMin=new UAVObjectField<Int16>("RssiMin", "", RssiMinElemNames, null, this);
			fields.Add(RssiMin);

			List<String> RssiPwmPeriodElemNames = new List<String>();
			RssiPwmPeriodElemNames.Add("0");
			RssiPwmPeriod=new UAVObjectField<Int16>("RssiPwmPeriod", "us", RssiPwmPeriodElemNames, null, this);
			fields.Add(RssiPwmPeriod);
			...
			ChannelMinElemNames.Add("Arming");
			...
			ChannelNeutralElemNames.Add("Arming");
			...
			ChannelMaxElemNames.Add("Arming");
			...
			ChannelGroupsElemNames.Add("Arming");
			...
			ChannelGroupsEnumOptions.Add("HoTT SUM");
			...
			List<String> RssiTypeElemNames = new List<String>();
			RssiTypeElemNames.Add("0");
			List<String> RssiTypeEnumOptions = new List<String>();
			RssiTypeEnumOptions.Add("None");
			RssiTypeEnumOptions.Add("PWM");
			RssiTypeEnumOptions.Add("PPM");
			RssiTypeEnumOptions.Add("ADC");
			RssiType=new UAVObjectField<RssiTypeUavEnum>("RssiType", "Rssi Type", RssiTypeElemNames, RssiTypeEnumOptions, this);
			fields.Add(RssiType);

			List<String> RssiChannelNumberElemNames = new List<String>();
			RssiChannelNumberElemNames.Add("0");
			RssiChannelNumber=new UAVObjectField<byte>("RssiChannelNumber", "channel", RssiChannelNumberElemNames, null, this);
			fields.Add(RssiChannelNumber);
			...
			ChannelNumberElemNames.Add("Arming");
			...
			Stabilization1SettingsEnumOptions.Add("Horizon");
			...
			Stabilization2SettingsEnumOptions.Add("Horizon");
			...
			Stabilization3SettingsEnumOptions.Add("Horizon");
			...
			FlightModePositionEnumOptions.Add("Acro");
			FlightModePositionEnumOptions.Add("Leveling");
			FlightModePositionEnumOptions.Add("VirtualBar");
		...
		public void setDefaultFieldValues()
		{
			...
			RssiMax.setValue((Int16)2000);
			RssiMin.setValue((Int16)1000);
			RssiPwmPeriod.setValue((Int16)260);
			...
			ChannelNeutral.setValue((Int16)1500,9);
			...
			ChannelMax.setValue((Int16)2000,9);
			...
			ChannelGroups.setValue(ChannelGroupsUavEnum.None,9);
			RssiType.setValue(RssiTypeUavEnum.None);
			RssiChannelNumber.setValue((byte)0);
			...
			ChannelNumber.setValue((byte)0,9);
