...
namespace UavTalk
{
	...
	{
		public const long OBJID = 3269734842;
		...
		public FlightStatus() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
			...
			FlightModeEnumOptions.Add("Acro");
			FlightModeEnumOptions.Add("Leveling");
			FlightModeEnumOptions.Add("VirtualBar");
			...
			FlightModeEnumOptions.Add("TabletControl");
