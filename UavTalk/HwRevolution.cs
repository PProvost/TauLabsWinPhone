...
namespace UavTalk
{
	...
	{
		public const long OBJID = 823250432;
		...
		public HwRevolution() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
			...
			AuxPortEnumOptions.Add("MavLinkTX");
			AuxPortEnumOptions.Add("MavLinkTX_GPS_RX");
			AuxPortEnumOptions.Add("HoTT SUMD");
			AuxPortEnumOptions.Add("HoTT SUMH");
			AuxPortEnumOptions.Add("HoTT Telemetry");
			AuxPortEnumOptions.Add("PicoC");
			AuxPortEnumOptions.Add("FrSKY SPort Telemetry");
			...
			AuxSBusPortEnumOptions.Add("MavLinkTX");
			AuxSBusPortEnumOptions.Add("MavLinkTX_GPS_RX");
			AuxSBusPortEnumOptions.Add("HoTT SUMD");
			AuxSBusPortEnumOptions.Add("HoTT SUMH");
			AuxSBusPortEnumOptions.Add("HoTT Telemetry");
			AuxSBusPortEnumOptions.Add("PicoC");
			AuxSBusPortEnumOptions.Add("FrSKY SPort Telemetry");
			...
			FlexiPortEnumOptions.Add("HoTT SUMD");
			FlexiPortEnumOptions.Add("HoTT SUMH");
			FlexiPortEnumOptions.Add("HoTT Telemetry");
			FlexiPortEnumOptions.Add("PicoC");
