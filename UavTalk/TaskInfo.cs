...
namespace UavTalk
{
	...
	{
		public const long OBJID = 2608584530;
		...
		public TaskInfo() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
			...
			StackRemainingElemNames.Add("UAVOLighttelemetryBridge");
			StackRemainingElemNames.Add("UAVORelay");
			...
			StackRemainingElemNames.Add("UAVOFrSKYSensorHubBridge");
			StackRemainingElemNames.Add("PicoC");
			StackRemainingElemNames.Add("UAVOFrSkySPortBridge");
			...
			RunningElemNames.Add("UAVOLighttelemetryBridge");
			RunningElemNames.Add("UAVORelay");
			RunningElemNames.Add("VibrationAnalysis");
			RunningElemNames.Add("Battery");
			RunningElemNames.Add("UAVOHoTTBridge");
			RunningElemNames.Add("UAVOFrSKYSBridge");
			RunningElemNames.Add("PicoC");
			RunningElemNames.Add("UAVOFrSkySPortBridge");
			...
			RunningTimeElemNames.Add("UAVOLighttelemetryBridge");
			RunningTimeElemNames.Add("UAVORelay");
			RunningTimeElemNames.Add("VibrationAnalysis");
			RunningTimeElemNames.Add("Battery");
			RunningTimeElemNames.Add("UAVOHoTTBridge");
			RunningTimeElemNames.Add("UAVOFrSKYSensorHubBridge");
			RunningTimeElemNames.Add("PicoC");
			RunningTimeElemNames.Add("UAVOFrSkySPortBridge");
