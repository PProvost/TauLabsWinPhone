...
namespace UavTalk
{
	...
	{
		public const long OBJID = 1717580478;
		public int NUMBYTES { get; set; }
		protected const String NAME = "HwColibri";
		...
		public HwColibri() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
		...
		{
			Frame.setValue(FrameUavEnum.Gemini);
			RcvrPort.setValue(RcvrPortUavEnum.PPM);
			...
			GyroRange.setValue(GyroRangeUavEnum.v2000);
		 ...
		 */
		public HwColibri GetInstance(UAVObjectManager objMngr, long instID)
		{
			return (HwColibri)(objMngr.getObject(HwColibri.OBJID, instID));
		}
	}
}
