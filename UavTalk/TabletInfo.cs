...
namespace UavTalk
{
	...
	{
		public const long OBJID = 3087844274;
		...
		public UAVObjectField<POIUavEnum> POI;
		...
		public TabletInfo() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
			...
			List<String> POIElemNames = new List<String>();
			POIElemNames.Add("0");
			List<String> POIEnumOptions = new List<String>();
			POIEnumOptions.Add("False");
			POIEnumOptions.Add("True");
			POI=new UAVObjectField<POIUavEnum>("POI", "", POIElemNames, POIEnumOptions, this);
			fields.Add(POI);
