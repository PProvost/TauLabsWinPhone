...
namespace UavTalk
{
	...
	{
		public const long OBJID = 1523690;
		...
		public enum OutPortUavEnum
		{
			[Description("PWM10")]
			PWM10 = 0, 
			[Description("PWM7+3ADC")]
			PWM73ADC = 1, 
			[Description("PWM8+2ADC")]
			PWM82ADC = 2, 
			[Description("PWM9+PWM_IN")]
			PWM9PWMIN = 3, 
			[Description("PWM7+PWM_IN+2ADC")]
			PWM7PWMIN2ADC = 4, 
		}
		public UAVObjectField<OutPortUavEnum> OutPort;
		...
		public HwSparky() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
			...
			MainPortEnumOptions.Add("HoTT Telemetry");
			MainPortEnumOptions.Add("FrSKY Sensor Hub");
			MainPortEnumOptions.Add("LighttelemetryTx");
			MainPortEnumOptions.Add("FrSKY SPort Telemetry");
			MainPort=new UAVObjectField<MainPortUavEnum>("MainPort", "function", MainPortElemNames, MainPortEnumOptions, this);
			fields.Add(MainPort);

			List<String> OutPortElemNames = new List<String>();
			OutPortElemNames.Add("0");
			List<String> OutPortEnumOptions = new List<String>();
			OutPortEnumOptions.Add("PWM10");
			OutPortEnumOptions.Add("PWM7+3ADC");
			OutPortEnumOptions.Add("PWM8+2ADC");
			OutPortEnumOptions.Add("PWM9+PWM_IN");
			OutPortEnumOptions.Add("PWM7+PWM_IN+2ADC");
			OutPort=new UAVObjectField<OutPortUavEnum>("OutPort", "function", OutPortElemNames, OutPortEnumOptions, this);
			fields.Add(OutPort);
		...
		public void setDefaultFieldValues()
		{
			...
			OutPort.setValue(OutPortUavEnum.PWM10);
