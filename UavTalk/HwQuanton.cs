...
namespace UavTalk
{
	...
	{
		public const long OBJID = 1834717102;
		...
		public enum MagnetometerUavEnum
		{
			[Description("Disabled")]
			Disabled = 0, 
			[Description("Internal")]
			Internal = 1, 
			[Description("ExternalI2CUart1")]
			ExternalI2CUart1 = 2, 
			[Description("ExternalI2CUart3")]
			ExternalI2CUart3 = 3, 
		}
		public UAVObjectField<MagnetometerUavEnum> Magnetometer;
		public enum ExtMagOrientationUavEnum
		{
			[Description("Top0degCW")]
			Top0degCW = 0, 
			[Description("Top90degCW")]
			Top90degCW = 1, 
			[Description("Top180degCW")]
			Top180degCW = 2, 
			[Description("Top270degCW")]
			Top270degCW = 3, 
			[Description("Bottom0degCW")]
			Bottom0degCW = 4, 
			[Description("Bottom90degCW")]
			Bottom90degCW = 5, 
			[Description("Bottom180degCW")]
			Bottom180degCW = 6, 
			[Description("Bottom270degCW")]
			Bottom270degCW = 7, 
		}
		public UAVObjectField<ExtMagOrientationUavEnum> ExtMagOrientation;
		...
		public HwQuanton() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
			...
			Uart1EnumOptions.Add("HoTT SUMD");
			Uart1EnumOptions.Add("HoTT SUMH");
			Uart1EnumOptions.Add("HoTT Telemetry");
			Uart1EnumOptions.Add("FrSKY Sensor Hub");
			Uart1EnumOptions.Add("LighttelemetryTx");
			Uart1EnumOptions.Add("PicoC");
			Uart1EnumOptions.Add("FrSKY SPort Telemetry");
			...
			Uart2EnumOptions.Add("HoTT SUMD");
			Uart2EnumOptions.Add("HoTT SUMH");
			Uart2EnumOptions.Add("HoTT Telemetry");
			Uart2EnumOptions.Add("FrSKY Sensor Hub");
			Uart2EnumOptions.Add("LighttelemetryTx");
			Uart2EnumOptions.Add("PicoC");
			Uart2EnumOptions.Add("FrSKY SPort Telemetry");
			...
			Uart3EnumOptions.Add("HoTT SUMD");
			Uart3EnumOptions.Add("HoTT SUMH");
			Uart3EnumOptions.Add("HoTT Telemetry");
			Uart3EnumOptions.Add("FrSKY Sensor Hub");
			Uart3EnumOptions.Add("LighttelemetryTx");
			Uart3EnumOptions.Add("PicoC");
			Uart3EnumOptions.Add("FrSKY SPort Telemetry");
			...
			Uart4EnumOptions.Add("HoTT SUMD");
			Uart4EnumOptions.Add("HoTT SUMH");
			Uart4EnumOptions.Add("HoTT Telemetry");
			Uart4EnumOptions.Add("LighttelemetryTx");
			Uart4EnumOptions.Add("FrSKY Sensor Hub");
			Uart4EnumOptions.Add("PicoC");
			Uart4EnumOptions.Add("FrSKY SPort Telemetry");
			...
			Uart5EnumOptions.Add("HoTT SUMD");
			Uart5EnumOptions.Add("HoTT SUMH");
			Uart5EnumOptions.Add("HoTT Telemetry");
			Uart5EnumOptions.Add("FrSKY Sensor Hub");
			Uart5EnumOptions.Add("LighttelemetryTx");
			Uart5EnumOptions.Add("PicoC");
			Uart5EnumOptions.Add("FrSKY SPort Telemetry");
			...
			USB_VCPPortEnumOptions.Add("PicoC");
			...
			List<String> MagnetometerElemNames = new List<String>();
			MagnetometerElemNames.Add("0");
			List<String> MagnetometerEnumOptions = new List<String>();
			MagnetometerEnumOptions.Add("Disabled");
			MagnetometerEnumOptions.Add("Internal");
			MagnetometerEnumOptions.Add("ExternalI2CUart1");
			MagnetometerEnumOptions.Add("ExternalI2CUart3");
			Magnetometer=new UAVObjectField<MagnetometerUavEnum>("Magnetometer", "function", MagnetometerElemNames, MagnetometerEnumOptions, this);
			fields.Add(Magnetometer);

			List<String> ExtMagOrientationElemNames = new List<String>();
			ExtMagOrientationElemNames.Add("0");
			List<String> ExtMagOrientationEnumOptions = new List<String>();
			ExtMagOrientationEnumOptions.Add("Top0degCW");
			ExtMagOrientationEnumOptions.Add("Top90degCW");
			ExtMagOrientationEnumOptions.Add("Top180degCW");
			ExtMagOrientationEnumOptions.Add("Top270degCW");
			ExtMagOrientationEnumOptions.Add("Bottom0degCW");
			ExtMagOrientationEnumOptions.Add("Bottom90degCW");
			ExtMagOrientationEnumOptions.Add("Bottom180degCW");
			ExtMagOrientationEnumOptions.Add("Bottom270degCW");
			ExtMagOrientation=new UAVObjectField<ExtMagOrientationUavEnum>("ExtMagOrientation", "function", ExtMagOrientationElemNames, ExtMagOrientationEnumOptions, this);
			fields.Add(ExtMagOrientation);
		...
		public void setDefaultFieldValues()
		{
			...
			Magnetometer.setValue(MagnetometerUavEnum.Internal);
			ExtMagOrientation.setValue(ExtMagOrientationUavEnum.Top0degCW);
		}
