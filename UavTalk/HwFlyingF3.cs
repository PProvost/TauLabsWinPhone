...
namespace UavTalk
{
	...
	{
		public const long OBJID = 3876151956;
		...
		public UAVObjectField<L3GD20RateUavEnum> L3GD20Rate;
		...
		public HwFlyingF3() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
			...
			List<String> L3GD20RateElemNames = new List<String>();
			L3GD20RateElemNames.Add("0");
			List<String> L3GD20RateEnumOptions = new List<String>();
			L3GD20RateEnumOptions.Add("380");
			L3GD20RateEnumOptions.Add("760");
			L3GD20Rate=new UAVObjectField<L3GD20RateUavEnum>("L3GD20Rate", "", L3GD20RateElemNames, L3GD20RateEnumOptions, this);
			fields.Add(L3GD20Rate);
			...
			ShieldEnumOptions.Add("CheBuzz");
			ShieldEnumOptions.Add("BMP085");
		...
		public void setDefaultFieldValues()
		{
			...
			L3GD20Rate.setValue(L3GD20RateUavEnum.v380);
